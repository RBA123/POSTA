...
import { signUpWithEmail, signInWithEmail, signOut, resetPassword } from "../services/auth.service";
...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const handleAuthStateChange = useCallback(async (authUser: FirebaseUser | null) => {
    ...
    try {
      ...
      try {
        console.log("📤 [AuthContext] Fetching profile for uid:", authUser.uid);
  ...
  const contextValue = useMemo(
    ...
    [user, loading, profileExists, error, handleSignUp, handleSignIn, handleSignOut, handleResetPassword, clearError]
  );
