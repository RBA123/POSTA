        ...
        <View className="gap-5">
          ...
          <View>
            ...
            <View className="flex-row gap-2">
              ...
              <View className="flex-1">
                <Text className="text-xs text-muted-foreground mb-1">Día</Text>
                <Input
                  value={day?.toString() || ''}
                  onChangeText={(text) => {
              ...
              {/* Month picker */}
              <View className="flex-1">
                <Text className="text-xs text-muted-foreground mb-1">Mes</Text>
                <Input
              ...
              {/* Year picker */}
              <View className="flex-1">
                <Text className="text-xs text-muted-foreground mb-1">Año</Text>
                <Input
                  value={year?.toString() || ''}
                  onChangeText={(text) => {
                    const num = parseInt(text) || null;
                    if (num && num >= 1900 && num <= currentYear) setYear(num);
          ...
          <View>
            ...
            <View className="flex-row gap-2">
              ...
              >
                ...
                <Text className="text-foreground font-medium">{phoneCode.code}</Text>
