...
type Category = 'en_vivo' | 'partidos' | 'torneos' | 'fase_grupos' | 'jugadores';
        ...
        <View className="flex-row items-center justify-between">
          <View className="flex-row items-center gap-3">
            ...
            <View>
              ...
              <Text className="text-xs text-muted-foreground">{countryName}</Text>
            </View>
          </View>
          <View className="items-end">
            <Text className="text-xs text-muted-foreground">Tu balance</Text>
            <Text className="text-xl font-bold text-primary">${balance.toFixed(2)}</Text>
          </View>
        </View>
      </View>
